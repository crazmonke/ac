...
<div style="max-width: 800px; margin: 0 auto; padding: 24px 16px;">
    ...
    <form method="post" action="{{ route('admin.banners.store') }}" style="background: #fff; border: 1px solid #e0e6ed; border-radius: 8px; padding: 24px;">
        @csrf
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="title" value="{{ old('title') }}" required style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
        </div>

        <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #15243a;">배너 설명</label>
            <textarea name="description" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; min-height: 80px; resize: vertical; box-sizing: border-box;">{{ old('description') }}</textarea>
        </div>
        ...
        <div style="margin-bottom: 20px; display: {{ old('type') === 'image' ? 'block' : 'none' }};" id="image-field">
            ...
            <input type="url" name="image_url" value="{{ old('image_url') }}" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            ...
            <div id="image-upload-area" style="border: 2px dashed #d6e0ea; border-radius: 8px; padding: 20px; text-align: center; cursor: pointer; transition: border-color .2s;" onclick="document.getElementById('image_file_pick').click()">
                <div id="image-upload-label" style="color: #607086; font-size: 0.9rem;">파일을 클릭하거나 여기에 드롭하세요</div>
        ...
        <div style="margin-bottom: 20px; display: {{ old('type') === 'video' ? 'block' : 'none' }};" id="video-field">
            ...
            <input type="url" name="video_url" value="{{ old('video_url') }}" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            <p style="margin: 10px 0 6px; color: #607086; font-size: 0.9rem;">또는 파일 직접 업로드 (최대 100MB · MP4, WebM, OGG)</p>
            <input type="hidden" name="video_path" id="video_path" value="{{ old('video_path') }}">
            <div id="video-upload-area" style="border: 2px dashed #d6e0ea; border-radius: 8px; padding: 20px; text-align: center; cursor: pointer; transition: border-color .2s;" onclick="document.getElementById('video_file_pick').click()">
                <div id="video-upload-label" style="color: #607086; font-size: 0.9rem;">파일을 클릭하거나 여기에 드롭하세요</div>
            </div>
        ...
        <div style="margin-bottom: 20px; display: {{ old('type') === 'text' ? 'block' : 'none' }};" id="text-field">
            ...
            <textarea name="text_content" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; min-height: 100px; resize: vertical; box-sizing: border-box;">{{ old('text_content') }}</textarea>
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
            <div>
                <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #15243a;">배너 링크 URL</label>
                <input type="url" name="button_url" value="{{ old('button_url') }}" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            ...
            <div>
                ...
                <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
            <div>
                ...
                <input type="date" name="start_date" value="{{ old('start_date') }}" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            </div>
            <div>
                <label style="display: block; margin-bottom: 6px; font-weight: 600; color: #15243a;">노출 종료일</label>
                <input type="date" name="end_date" value="{{ old('end_date') }}" style="width: 100%; padding: 10px 12px; border: 1px solid #d6e0ea; border-radius: 6px; font-family: inherit; font-size: 1rem; box-sizing: border-box;">
            </div>
        </div>
        ...
        <div id="submit-area" style="display: flex; gap: 12px; align-items: center;">
            <button type="submit" id="submit-btn" class="btn btn-primary">배너 추가</button>
